...
OhdsiRTools::checkUsagePackage("SchizoRiskOfAceInhibitor")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/SchizoRiskOfAceInhibitor.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SchizoRiskOfAceInhibitor.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "SchizoRiskOfAceInhibitor")
...
OhdsiRTools::createRenvLockFile("SchizoRiskOfAceInhibitor")
